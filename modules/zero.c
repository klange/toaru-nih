...
static uint32_t read_null(fs_node_t *node, koff_t offset, uint32_t size, uint8_t *buffer);
static uint32_t write_null(fs_node_t *node, koff_t offset, uint32_t size, uint8_t *buffer);
static void open_null(fs_node_t *node, unsigned int flags);
static void close_null(fs_node_t *node);
static uint32_t read_zero(fs_node_t *node, koff_t offset, uint32_t size, uint8_t *buffer);
static uint32_t write_zero(fs_node_t *node, koff_t offset, uint32_t size, uint8_t *buffer);
