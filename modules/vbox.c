...
static uint32_t _vbox_write(fs_node_t *node, koff_t offset, uint32_t size, uint8_t *buffer) {
...
uint32_t write_pointer(fs_node_t * node, koff_t offset, uint32_t size, uint8_t *buffer) {
...
uint32_t write_rectpipe(fs_node_t *node, koff_t offset, uint32_t size, uint8_t *buffer) {
	(void)node;
	(void)offset;
