...
static uint32_t read_random(fs_node_t *node, koff_t offset, uint32_t size, uint8_t *buffer);
static uint32_t write_random(fs_node_t *node, koff_t offset, uint32_t size, uint8_t *buffer);
