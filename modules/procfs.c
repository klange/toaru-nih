...
static uint32_t proc_cmdline_func(fs_node_t *node, koff_t offset, uint32_t size, uint8_t *buffer) {
	char buf[1024];
...
static uint32_t proc_status_func(fs_node_t *node, koff_t offset, uint32_t size, uint8_t *buffer) {
	char buf[2048];
	process_t * proc = process_from_pid(node->inode);
...
static uint32_t cpuinfo_func(fs_node_t *node, koff_t offset, uint32_t size, uint8_t *buffer) {
	char buf[1024];
...
static uint32_t meminfo_func(fs_node_t *node, koff_t offset, uint32_t size, uint8_t *buffer) {
	char buf[1024];
...
static uint32_t pat_func(fs_node_t *node, koff_t offset, uint32_t size, uint8_t *buffer) {
	char buf[1024];
...
static uint32_t uptime_func(fs_node_t *node, koff_t offset, uint32_t size, uint8_t *buffer) {
	char buf[1024];
...
static uint32_t cmdline_func(fs_node_t *node, koff_t offset, uint32_t size, uint8_t *buffer) {
	char buf[1024];
	extern char * cmdline;
	sprintf(buf, "%s\n", cmdline ? cmdline : "");
...
static uint32_t version_func(fs_node_t *node, koff_t offset, uint32_t size, uint8_t *buffer) {
	char buf[1024];
...
static uint32_t compiler_func(fs_node_t *node, koff_t offset, uint32_t size, uint8_t *buffer) {
	char buf[1024];
...
static uint32_t mounts_func(fs_node_t *node, koff_t offset, uint32_t size, uint8_t *buffer) {
...
static uint32_t netif_func(fs_node_t *node, koff_t offset, uint32_t size, uint8_t *buffer) {
	char * buf = malloc(4096);
...
static uint32_t modules_func(fs_node_t *node, koff_t offset, uint32_t size, uint8_t *buffer) {
...
static uint32_t filesystems_func(fs_node_t *node, koff_t offset, uint32_t size, uint8_t *buffer) {
...
static uint32_t loader_func(fs_node_t *node, koff_t offset, uint32_t size, uint8_t *buffer) {
	char * buf = malloc(512);
...
static uint32_t irq_func(fs_node_t *node, koff_t offset, uint32_t size, uint8_t *buffer) {
	char * buf = malloc(4096);
	unsigned int soffset = 0;
...
static uint32_t pci_func(fs_node_t *node, koff_t offset, uint32_t size, uint8_t *buffer) {
	size_t count = 0;
